...
//		database.execSQL(settings);
    ...
    public void insertSession(HashMap<String, String> queryValues){
        ...
        values.put("EMAIL_ADDRESS", queryValues.get("EMAIL_ADDRESS"));
        ...
        values.put("LAST_MODIFIED", queryValues.get("LAST_MODIFIED"));
    ...
    public ArrayList<HashMap<String, String>> getAllSessions(){
        ...
        if(cursor.moveToFirst()){
            ...
            do{
                ...
                sessionMap.put("EMAIL_ADDRESS", cursor.getString(1));
                sessionMap.put("PASSWORD", cursor.getString(2));
                sessionMap.put("STATUS", cursor.getString(3));
                sessionMap.put("NAME", cursor.getString(4));
                sessionMap.put("PHONE_NUMBER", cursor.getString(5));
                sessionMap.put("CATEGORY", cursor.getString(6));
                sessionMap.put("LAST_UPDATED", cursor.getString(7));
                sessionMap.put("USER_SERVER_ID", cursor.getString(8));
