...
public class CBTQuestionHttpServiceAdapter {
	...
	{ 
		String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetQuestionBySubjectTypeIdAndQuestionNo";
	...
	{
		String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetAllQuestions";
	...
	public ArrayList<JSONObject> GetQuestionBySubjectTypeId(String subjectTypeId)
	{ 
		String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetQuestionBySubjectTypeId";
