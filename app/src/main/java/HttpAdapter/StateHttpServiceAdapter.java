...
/**
 * Created by Chisom on 5/26/2019.
 */
...
public class StateHttpServiceAdapter {
    ...
    public ArrayList<JSONObject> GetAllStates()
    {
        ...
        String OPERATION_NAME_GetJsonData = "GetAllStates";
...
//        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetUserByUserNameAndPassword";
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetStateById";
...
//            }
    ...
    public JSONObject GetStateByStateName(String stateName)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetStateByStateName";
...
//            }
    ...
    public ArrayList<JSONObject> GetStateByCountryId(String countryId)
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetStateByCountryId";
        String OPERATION_NAME_GetJsonData = "GetStateByCountryId";
