...
//            }
    ...
    public ArrayList<JSONObject> GetELearningContentByGradeIdAndSubjectId(String gradeId, String subjectId)
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetELearningContentByGradeIdAndSubjectId";
        String OPERATION_NAME_GetJsonData = "GetELearningContentByGradeIdAndSubjectId";
    ...
    public ArrayList<JSONObject> GetELearningContentByTitleWildCardGradeIdAndSubjectId(String titleString, String gradeId, String subjectId)
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetELearningContentByTitleWildCardGradeIdAndSubjectId";
        String OPERATION_NAME_GetJsonData = "GetELearningContentByTitleWildCardGradeIdAndSubjectId";
        ...
        {
            SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,OPERATION_NAME_GetJsonData);
            request.addProperty("titleString", titleString);
            request.addProperty("gradeId", gradeId);
            request.addProperty("subjectId", subjectId);
            SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
            envelope.dotNet = true;
