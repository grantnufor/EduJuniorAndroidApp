...
public class SchoolFeeHttpServiceAdapter {
    ...
    String SOAP_ADDRESS ="http://edujunior.co.uk/WebServices/SchoolFeeServices.asmx";
    ...
    public ArrayList<JSONObject> GetSchoolFeeByPupilIdDatesFromAndTo(String pupilId,  String dateFromDay, String dateFromMonth, String dateFromYear,
                                                                     String dateToDay, String dateToMonth, String dateToYear)
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetSchoolFeeByPupilIdDatesFromAndTo";
        String OPERATION_NAME_GetJsonData = "GetSchoolFeeByPupilIdDatesFromAndTo";
