...
public class LocationHttpServiceAdapter {
    ...
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetAllLocations";
        String OPERATION_NAME_GetJsonData = "GetAllLocations";
...
//        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetUserByUserNameAndPassword";
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetLocationById";
...
//            }
    ...
    public String GetLocationByLocationName(String locationName)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetLocationByLocationName";
...
//            }
    ...
    public ArrayList<JSONObject> GetLocationByStateId(String stateId)
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetLocationByStateId";
        String OPERATION_NAME_GetJsonData = "GetLocationByStateId";
    ...
    public String GetLocationByLocationNameAndStateId(String locationName, String stateId)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetLocationByLocationNameAndStateId";
