...
public class ELearningSubjectHttpServiceAdapter {
    ...
    public ArrayList<JSONObject> GetAllELearningSubjects()
    {
        ...
        String OPERATION_NAME_GetJsonData = "GetAllELearningSubjects";
    ...
    public JSONObject GetELearningSubjectById(String eLearningSubjectId)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetELearningSubjectById";
...
//            }
    ...
    public ArrayList<JSONObject> GetELearningByELearningGradeId(String eLearningGradeId)
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetELearningByELearningGradeId";
        String OPERATION_NAME_GetJsonData = "GetELearningByELearningGradeId";
    ...
    public JSONObject GetELearningSubjectBySubjectName(String subjectName)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetELearningSubjectBySubjectName";
